...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "xOH8DN1tdaNJYL4oyRB5CThFqMho5Pr4xaey47CO";
    private static final String SECRETKEY = "PsYOLEtNfJiP8XaTJHgYZw7MjB9Lwbmgarpb2-3J";
    private static final String BUCKET = "zthealth106";
    public static final String DOMAIN = "http://qmm8ii6g6.hn-bkt.clouddn.com/";
